...
public class TriangleRulerView extends View {
	...
	public TriangleRulerView setTextSize(int size) {
		mPaint.setTextSize(size);
		return this;
	}

	public TriangleRulerView setLineLength(int length) {
		lineLength = length;
		return this;
	}
	...
	private void drawRuler(Canvas canvas) {
        ...
        canvas.drawText("单位：cm",pxWidth - mPaint.measureText("单位：cm") - 100,lineLength * 4+ mPaint.getTextSize(),mPaint);
		// 绘制纵向刻度
